...
typedef k_thread_wrapper_t* cy_thread_t;            /** Zephyr definition of a thread handle */
typedef void*               cy_thread_arg_t;        /** Argument passed to the entry function of
                                                        a thread */
typedef struct k_mutex     cy_mutex_t;              /** Zephyr definition of a mutex */
typedef struct k_sem       cy_semaphore_t;          /** Zephyr definition of a semaphore */
typedef struct k_event     cy_event_t;              /** Zephyr definition of an event */
typedef struct k_msgq      cy_queue_t;              /** Zephyr definition of a message queue */
typedef k_timer_wrapper_t  cy_timer_t;              /** Zephyr definition of a timer */
...
typedef int                cy_rtos_error_t;         /** Zephyr definition of a error status */
